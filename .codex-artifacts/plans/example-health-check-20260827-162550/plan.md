# Kế hoạch mẫu: bổ sung endpoint health check

## Mục tiêu

Bổ sung endpoint `GET /health` để hệ thống giám sát có thể xác định dịch vụ đang chạy và sẵn sàng nhận lưu lượng.
